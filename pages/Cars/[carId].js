...
const CarId = () => {
    ...
    if (!carDetails) {
        return <h3 className="flex items-center justify-center text-3xl bg-black w-full h-[649px] text-white">
            Car not found !</h3>;
    }
    ...
    return (
        ...
        <div className="container mx-auto p-4 bg-black max-w-[1100px] min-h-[649px]">
            <div className="bg-white flex xl:flex-row flex-col rounded-lg shadow-lg items-center overflow-hidden lg:flex">
                <img src={image} alt={name} className="w-full h-full max-w-[600px] mx-2 rounded-lg m-auto object-cover" />
                <div className="p-6">
