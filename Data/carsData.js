const carsData = [
    ...
    },
    {
      ...
      price: 99998,
      description:
        "The Taycan GTS Sport Turismo includes the same versatility and bold capacity as the Taycan 4 Cross Turismo, with a lower, sporty suspension instead of an off-road look. Engaging dynamics and exceptional comfort combine with peerless performance and everyday versatility. Everything you need without compromise.The Porsche Taycan 4S is a beautiful and sporty car. We have taken it up to the mountains, driven along the coast line, highway and local trips. It is truly amazing and fun car. Driving the Taycan is another form or relaxation. It drives like a Porsche and handles well. The electric sound is a cool addition. the style and design turn heads. The only thing to get use with this EV is to watch the eMiles remaining before the searching for a charging station.",
    ...
    },
    {
      ...
      price: 174000,
      description:
        "The G-Class enjoys unrivalled legendary status off-road. No wonder, as it masters all off-road disciplines effortlessly and with impressive values. This is thanks to the perfect interplay of all-wheel drive, differential locks, a ladder-type frame and the selectable off-road gear reduction.This all culminates in the fact that the traction of a single wheel is sufficient for propulsion. The harmonious suspension and shock absorption setup offers the best possible ride comfort even in demanding driving situations.",
